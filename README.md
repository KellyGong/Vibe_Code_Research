<h1 align="center">🎵 Vibe Coding & Vibe Research</h1>

<p align="center">
  <b>Let AI handle the heavy lifting — you set the vibe.</b><br>
  <sub>Practical tricks, scripts, tools, and workflows for AI-assisted development & research.</sub>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/Vibe-Coding-FF6B6B?style=for-the-badge" alt="Vibe Coding"/>
  <img src="https://img.shields.io/badge/Vibe-Research-4ECDC4?style=for-the-badge" alt="Vibe Research"/>
  <img src="https://img.shields.io/badge/Tools_%26-IDEs-845EC2?style=for-the-badge" alt="Tools"/>
</p>

<p align="center">
  <a href="#-quick-navigation"><b>Quick Nav</b></a> · 
  <a href="./vibe-coding/">Vibe Coding</a> · 
  <a href="./vibe-research/">Vibe Research</a> · 
  <a href="./tools-and-ides/">Tools & IDEs</a>
</p>
...
> **Vibe Coding** — Describe your intent in natural language, let AI write the code. You guide the _vibe_, the AI does the heavy lifting.
>
...
1. **Pick a section** that interests you from the table above.
2. Each section has its own detailed `README.md`.
3. Scripts live in `scripts/` subdirectories — check script headers for usage.
...
1. 从上方表格 **选一个板块** 开始。
2. 每个板块都有详细的 `README.md`。
3. 脚本位于 `scripts/` 子目录，查看脚本头部注释了解用法。
